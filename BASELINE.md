...
| PC-13 | A separate acceptance challenger is used only for an explicitly high-risk slice and contributes a small hostile-case set | Mandatory test-author ceremony growing without improving the normal delivery path | S, I | PROMPT + AUDIT | [L-001](LESSONS.md#l-001), [L-015](LESSONS.md#l-015) |
