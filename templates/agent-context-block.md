...
- Resolve open decisions in the contract before coding.
...
- Use one fresh independent reviewer on the exact final commit. Any later push makes
  that review stale.
- P1 and P2 review findings block. A third substantive review round stops the change;
  fix the contract or cut a smaller slice.
...
review-round limits, plain language, and independent AI review are prompt and audit
rules until this repository adds its own mechanical checks.
```
